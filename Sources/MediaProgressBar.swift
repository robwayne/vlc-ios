...
protocol MediaProgressBarDelegate {
    func didMoveMediaProgressSlider(_ progressBar: MediaProgressBar, sender: UISlider)
}

@objc (VLCMediaProgressBar)
@objcMembers class MediaProgressBar: UIView {
    
    // MARK: Instance Variables
    weak var delegate:  MediaProgressBarDelegate?
    ...
    @objc private func moveSliderThumb() {
        ...
        delegate?.didMoveMediaProgressSlider(self, sender: progressSlider)
    }
}
